...
namespace ConferenceStarterKit.Services
{
    public class ConferenceServiceMock : IConferenceService
    {
        ...
        public ObservableCollection<SessionItemModel> GetSessions()
        {
            ...
            Sessions.Add(new SessionItemModel { Date = DateTime.Now, Location="Central A", Description = "Some session information that I am sure you would like", Code = "DEV123", Title = "Introduction To WP" });
            Sessions.Add(new SessionItemModel { Date = DateTime.Now, Location="Central C", Description = "Some session information that I am sure you would like", Code = "DEV456", Title = "A really long session name that keeps going" });
